...
export default function Banner({ banner }) {
  ...
  return (
    <div
      className="shadow bg-cover bg-center bg-no-repeat w-full h-full"
      style={{
        backgroundImage: `url(${url})`
      }}>
      <div className="flex justify-center items-center md:justify-start w-full h-full p-8 bg-opacity-70 bg-gray-900">
        <div className="hidden sm:block">
          <Card item={banner} width={18} height={24}/>
        </div>
        <div className="pl-8" style={{width: '36rem'}}>
          <div className="h-20">
